' ==============================================================================
' ÅySMART PHOENIX LAUNCHERÅz v3.0 (Zero-Japanese Pure ASCII Fix)
' ==============================================================================
...
pythonw = "C:\Users\kanku\OneDrive\Weekly report\python_embed\pythonw.exe"
...
If computerName = "G580" Then
    ...
    receptorScript = baseDir & "\Phoenix_Protocol\éËèpë‰_âñUé∫\02_RECEPTOR_SYNAPSE.py"
Else
    profileLabel = "Home"
    watchdogScript = baseDir & "\Phoenix_Protocol\SNIPER_WATCHDOG.py"
    receptorScript = baseDir & "\Phoenix_Protocol\éËèpë‰_âñUé∫\02_RECEPTOR_SYNAPSE.py"
...
' DNA (Base64) for " ãNìÆäÆóπÅBñ≥âπÇ≈éÁåÏÇäJénÇµÇ‹Ç∑ÅB"
